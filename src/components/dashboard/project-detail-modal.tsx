  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 animate-in fade-in duration-200">
      ...
      <div className="relative z-10 w-full max-w-2xl max-h-[92vh] overflow-y-auto rounded-3xl border border-[#D4A853]/30 bg-[#101015]/95 p-5 sm:p-7 md:p-8 shadow-[0_0_50px_rgba(0,0,0,0.9)] backdrop-blur-2xl animate-in zoom-in-95 duration-200 space-y-6 text-white">
        ...
        {/* SECTION 2: MÉTRICAS DE TRÁFICO Y USUARIOS */}
        <div className="space-y-3">
          <h3 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
            <BarChart3 className="w-4 h-4 text-[#F38020]" /> Métricas de Tráfico & Visitantes
          </h3>
          ...
          <div className="p-5 rounded-2xl bg-[#14141c] border border-[#333]/80 space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="p-3.5 bg-[#1c1c26] rounded-xl border border-[#2a2a38]">
                <span className="text-[9px] text-[#999] uppercase font-bold tracking-wider flex items-center gap-1">
                  <Users className="w-3 h-3 text-[#D4A853]" /> Visitantes Únicos
                </span>
                <p className="text-base font-black text-white mt-1">~420 <span className="text-[10px] text-emerald-400 font-normal">/mes</span></p>
              </div>
              <div className="p-3.5 bg-[#1c1c26] rounded-xl border border-[#2a2a38]">
                <span className="text-[9px] text-[#999] uppercase font-bold tracking-wider flex items-center gap-1">
                  <MousePointerClick className="w-3 h-3 text-blue-400" /> Vistas de Página
                </span>
                <p className="text-base font-black text-white mt-1">~1,850 <span className="text-[10px] text-blue-400 font-normal">/mes</span></p>
              </div>
              <div className="p-3.5 bg-[#1c1c26] rounded-xl border border-[#2a2a38]">
                <span className="text-[9px] text-[#999] uppercase font-bold tracking-wider flex items-center gap-1">
                  <TrendingUp className="w-3 h-3 text-emerald-400" /> Tendencia
                </span>
                <p className="text-base font-black text-emerald-400 mt-1">+16.4%</p>
              </div>
              <div className="p-3.5 bg-[#1c1c26] rounded-xl border border-[#2a2a38]">
                <span className="text-[9px] text-[#999] uppercase font-bold tracking-wider flex items-center gap-1">
                  <Clock className="w-3 h-3 text-amber-400" /> Tiempo Medio
                </span>
                <p className="text-base font-black text-white mt-1">1m 45s</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-blue-600/15 hover:bg-blue-600/25 border border-blue-500/40 text-blue-400 text-xs font-bold transition-all active:scale-95"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-[#F38020]/15 hover:bg-[#F38020]/25 border border-[#F38020]/40 text-[#F38020] text-xs font-bold transition-all active:scale-95"
              >
